...
class FuzzyBollingerBandStrategy(Strategy):
    ...
    def generate_signals(self):
        ...
        signals['fuzzyInputUpperBand'] = 100 * ((signals['close'] - signals['upperBand'])/signals['close'] )
        signals['fuzzyInputlowerBand'] = 100 * ((signals['close'] - signals['lowerBand'])/signals['close'] )
        print('fuzzy Input')
        print(signals['fuzzyInputUpperBand'])
        print(signals['fuzzyInputlowerBand'])
        fuzzythreshold = 0.225
        ...
        i = 0
        for x in signals['fuzzyInputUpperBand']:
            ...
            i=i+1
        i = 0
        for x in signals['fuzzyInputlowerBand']:
