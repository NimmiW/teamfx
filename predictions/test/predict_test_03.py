...
def predict(date_time, count):
    ...
    with sess.as_default():
        ...
        predicted_close = invert_min_max_for_one_feature(np.array(predicted_close), 'minmaxvalues_all_data_2017', 'next_close')
        ...
        predicted_next_next_close = invert_min_max_for_one_feature(np.array(normalized_next_next_close), 'minmaxvalues_all_data_2017','next_next_close')
        ...
        predicted_next_next_next_close = invert_min_max_for_one_feature(np.array(normalized_next_next_next_close),'minmaxvalues_all_data_2017', 'next_next_close')
        ...
        predictions_list = invert_min_max_for_one_feature(np.array(predictions_next_close_label), 'minmaxvalues_all_data_2017', 'next_close')
        predictions_list = predictions_list.values.tolist()
        predictions_list = [item for sublist in predictions_list for item in sublist]

        predictions_next_next_close_list = invert_min_max_for_one_feature(np.array(predictions_next_next_close_label),'minmaxvalues_all_data_2017', 'next_next_close')
        ...
        predictions_next_next_next_close_list = invert_min_max_for_one_feature(np.array(predictions_next_next_next_close_label),'minmaxvalues_all_data_2017', 'next_next_next_close')
...
########################################################################################################################
    ...
    f_n_n = [item for sublist in next_next_close_ann_arima for item in sublist]     #[x for x in next_next_close_ann_arima]
    next_next_next_close_ann_arima = final_results_next__next_next_close.values.tolist()
    f_n_n_n = [item for sublist in next_next_next_close_ann_arima for item in sublist]   #[x for x in next_next_next_close_ann_arima]
