...
def predict(date_time, count):
    ...
    return errors, predicted_close, forward_date_time, predicted_next_next_close, forward_next_next_date_time, predicted_next_next_next_close, forward_next_next_next_date_time,actual_values_forward, actual_list_buffer, backward_date_time

def predict_arima_ann(date_time,count):

    errors, predictions_from_ann, forwared_date_time, predicted_next_next_close, forward_next_next_date_time, predicted_next_next_next_close, forward_next_next_next_date_time, actual_values_forward, actual_close,backward_date_time = predict( date_time, count)
